<link rel="stylesheet" href="assets/css/foodStyles.css">
<!-- ***** Menu Area Starts ***** -->
                        ...
                        <div style="background-image: url('/foodimage/{{$data->image}}');" class='card'>
                            ...
                            <div class='info'>
                              ...
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make a reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                            </div>
                        </div>

                    <input type="number" name="quantity" min="1" value="1" id="width80px">
