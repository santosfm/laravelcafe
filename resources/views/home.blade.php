            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <li class="scroll-to-section"><a href="http://127.0.0.1:8000/" class="active">Home</a></li>
                        ...
                        <a class='menu-trigger'>
                            <span id="menuTriggerColor">Menu</span>  <!-- style="color:#FB6356" -->
                        </a>
                        <!-- ***** Menu End ***** -->
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Klassy Cafe is is a café located in Glasgow. We try to use organic and fairtrade ingredients as much as we can. We have some Portuguese, Spanish and British dishes. Please see our selection. Please contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
                                                ...
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            ...
                                                            <p>Fresh Chicken Salad Spanish style.</p>
                                                            <div class="price">
                                                                <h6>£9.50</h6>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="assets/images/tab-item-01.png" alt="">
                                                            <h4>Vegetarian mix</h4>
                                                            <p>Our speciality. Portuguese seafood platter.</p>
                                                            <div class="price">
                                                                <h6>£12</h6>
                                                            </div>
                                                        </div>
